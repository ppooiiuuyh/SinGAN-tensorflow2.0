...
parser.add_argument("--start_scale", type=int, default=8, help= 'num_scale')
parser.add_argument("--itr_per_scale", type=int, default=20000, help= 'train iteration per scale')
